"""
Django settings for web_uploader project.
...
SECRET_KEY = 'django-insecure-%)bq$nyj0(4ma$^#mt8s@a5fu3+u)vgbj&%*bkah&85mb+35jq'
...
WSGI_APPLICATION = 'web_uploader.wsgi.application'
